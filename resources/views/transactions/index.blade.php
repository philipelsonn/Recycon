...
@section('content')
    ...
    @elseif (count($transactions) > 0)
        <div class="container-fluid">
            ...
            <div class="accordion accordion-flush" id="accordionFlush{{ $count }}">
                <div class="accordion-item">
                    ...
                    <div id="flush-collapse{{ $count }}" class="accordion-collapse collapse" aria-labelledby="flush-heading{{ $count }}" data-bs-parent="#accordionFlush{{ $count }}">
